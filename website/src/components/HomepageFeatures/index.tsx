...
const cards: CardItem[] = [
  ...
  },
  {
    ...
    description:
      'Business Analyst, Architect, Software Engineer, Code Reviewer, UI Reviewer, E2E Engineer, DevOps Engineer, Engineering Manager, Context Engineer, Copilot Engineer, and Copilot Orchestrator — each focused on its phase, working together in a structured sequence.',
  },
  {
