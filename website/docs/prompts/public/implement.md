...
A thin trigger that starts implementation delivery. It routes execution to the [Engineering Manager](../../agents/engineering-manager) agent on **Claude Sonnet 5** and hands off to the canonical orchestration workflow — it does not define that workflow inline.
...
- **Routes to one seat** — always hands off to the Engineering Manager on Claude Sonnet 5.
