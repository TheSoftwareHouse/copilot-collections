...
tools: ['runCommands', 'runTasks', 'Context7/*', 'Figma MCP Server/*', 'playwright/*', 'edit/createFile', 'edit/createDirectory', 'edit/editFiles', 'search', 'todos', 'runSubagent', 'usages', 'problems', 'testFailure', 'openSimpleBrowser', 'sequential-thinking/*']
handoffs: 
