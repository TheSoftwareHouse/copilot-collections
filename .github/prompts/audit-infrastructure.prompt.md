...
- `optimizing-cloud-cost` - for cost analysis patterns, rightsizing, and reservation recommendations
- `managing-secrets` - for secrets management audit criteria and exposure risk assessment
- `codebase-analysing` - to review IaC files, CI/CD configurations, and documentation coverage
...
- **Cost**: Follow `optimizing-cloud-cost` skill for unused resources, rightsizing, reservations
- **Secrets**: Follow `managing-secrets` skill for exposure risks
