...
- `implementing-ci-cd` - for pipeline patterns, deployment strategies, and GitOps workflows
- `managing-secrets` - for OIDC authentication setup and secrets handling
- `technical-context-discovering` - to establish project conventions and existing pipeline patterns

---

## 1. Context

Follow the `technical-context-discovering` skill to identify existing CI/CD setup.
...
Follow the `implementing-ci-cd` skill for:
