...
- `implementing-terraform-modules` - for module patterns, state management, and safe infrastructure changes
- `technical-context-discovering` - to establish project conventions and existing Terraform patterns

---

## 1. Context

Follow the `technical-context-discovering` skill to identify existing Terraform setup.
...
Follow the `implementing-terraform-modules` skill for:
