...
4. In case there are Figma designs linked to the task, review all of them using Figma MCP server (it's very important) and include relevant information in the context.
