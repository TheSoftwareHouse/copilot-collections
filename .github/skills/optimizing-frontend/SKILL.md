...
- `implementing-frontend` — for component patterns that support performant rendering
- `writing-hooks` — for memoization and cleanup patterns within custom hooks
- `reviewing-frontend` — for performance-focused code review spot-checks
